...
<body>
        ...
        <div class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container ">
                <div class="navbar-header">
                        <img src="icons/logo.png" alt="Royal Attire" height="50" />
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="drodown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Products<b
                            ...
                            <ul class="dropdown-menu ">
                                ...
                                <li><a href="ManDenims.aspx">Tshirts</a></li>                                
                            </ul>
                        </li>
                        <li>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="ImgSlider/1.jpeg" alt="Los Angeles" style="height: 900px; width: 100%;">
                        <div class="carousel-caption">
                            ...
                            <p>
                                40% off</p>
                            <p>
                                <a class="btn btn-lg btn-primary" href="#" role="button" onclick="showAlert()">Book Now</a>
                        </div>
                    </div>
                    <div class="item">
                        <img src="ImgSlider/2.jpeg" alt="Chicago" style="height: 900px; width: 100%;">
                        <div class="carousel-caption">
                            <h3>
                                designed tshirt </h3>
                            <p>
                    ...
                    <div class="item">
                        <img src="ImgSlider/3.jpeg" alt="New york" style="height: 900px; width: 100%;">
                        <div class="carousel-caption">
                            <h3>
                                Striped Suit 2 Piece Set</h3>
                            <p>
                                25% off</p>
                        </div>
                    </div>
    ...
    <div class="container center ">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><marquee>
               &#127879; NEW ARRIVALS &#127879;</marquee></div>
    ...
    <footer>
            <div class ="container ">
                ...
                <p>&copy;2025 Royal Attire &middot; <a href ="Default.aspx">Home</a>&middot;<a href ="#">About</a>&middot;<a href ="#">Contact</a>&middot;<a href ="#">Products</a> </p>
            </div>
