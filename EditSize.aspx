          ...
          <div class="row">
               <div class="col-sm-6">
                  ...
                  <div class="form-group">
                       ...
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSize" ErrorMessage="*Size is Required" ForeColor="Red"></asp:RequiredFieldValidator>
                  </div>
