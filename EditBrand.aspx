...
<div class="row">
         ...
         <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtID" ErrorMessage="*Brand sId is Required" ForeColor="Red"></asp:RequiredFieldValidator>
         ...
         <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtUpdateBrandName" ErrorMessage="*Brand name is Required" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
