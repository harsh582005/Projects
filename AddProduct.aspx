       ...
       <div class ="form-horizontal">
           ...
           <div class ="form-group">
               ...
               <div class ="col-md-3">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtProductName" ErrorMessage="Prdouct Name is mandatory" ForeColor="Red"></asp:RequiredFieldValidator>
           ...
           <div class ="form-group">
               ...
               <div class ="col-md-3">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPrice" ErrorMessage="Price is mandatory" ForeColor="Red"></asp:RequiredFieldValidator>
               </div>
           </div>
           ...
           <div class ="form-group">
               ...
               <div class ="col-md-3">
                   ...
                   <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPrice" ControlToValidate="txtsellPrice" ErrorMessage="Selling price should not be greater than price" ForeColor="Red" Operator="GreaterThan" SetFocusOnError="True"></asp:CompareValidator>
               </div>
           </div>
           ...
           <div class ="form-group">
            ...
            <div class ="form-group">
               ...
               <div class ="col-md-3">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="fuImg01" ErrorMessage="Image is mandatory" ForeColor="Red"></asp:RequiredFieldValidator>
               </div>
           </div>
