           ...
           <div class="row">
               ...
               <label>Enter SubCatID:</label>
                  <asp:TextBox ID="txtID" CssClass="form-control" runat="server" AutoPostBack="true"  ontextchanged="txtID_TextChanged"></asp:TextBox> 
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtID" ErrorMessage="*SubCatId is Required" ForeColor="Red"></asp:RequiredFieldValidator>
               </div>
               ...
               <label>Sub Category:</label>
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSubCategory" ErrorMessage="*Sub Category Name is Required" ForeColor="Red"></asp:RequiredFieldValidator>
               </div>
