          ...
          <div class="row">
             <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    <asp:Button ID="Button1" runat="server" CssClass ="btn btn-success " Text="Download" OnClick="Button1_Click"/>&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" CssClass ="btn btn-success " Text="Generate Monthly Report" OnClick="Button2_Click" />
