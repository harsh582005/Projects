    ...
    protected void btnResetPass_Click(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["MyShoppingDB"].ConnectionString))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody ="Hi ,"+Username + ",<br/><br/>Click the link below to reset your password<br/> <br/> http://localhost:42208/RecoverPassword.aspx?id=" + myGUID ;


                MailMessage PassRecMail = new MailMessage("bca@somlalit.org", ToEmailAddress );
                ...
                using (SmtpClient client = new SmtpClient())
                {
                    ...
                    client.Credentials = new NetworkCredential("bca@somlalit.org", "BcA@1302");
                    ...
                    catch (Exception ex)
                    {
                        ...
                        ClientScript.RegisterStartupScript(this.GetType(), "ErrorAlert",
                            "alert('Mail server is Currently not working');", true);
                    }
